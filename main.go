...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	speedInKmH := r.meanSpeed() * MinInHours
	durationInHours := r.Duration.Hours()
	return ((CaloriesMeanSpeedMultiplier*speedInKmH + CaloriesMeanSpeedShift) * r.Weight / MInKm * durationInHours)
}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	baseRunning := r.Training.TrainingInfo()
	baseRunning.Calories = r.Calories()
	return baseRunning
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	speedInMPerSec := w.meanSpeed() * KmHInMsec
	durationInHours := w.Duration.Hours()
	return ((CaloriesWeightMultiplier*w.Weight + math.Pow(speedInMPerSec, 2)/(w.Height/CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * durationInHours)
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	baseWalking := w.Training.TrainingInfo()
	baseWalking.Calories = w.Calories()
	return baseWalking
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	speedInKmH := s.meanSpeed() * MinInHours
	durationInHours := s.Duration.Hours()
	return ((speedInKmH + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * durationInHours)
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	baseSwimming := s.Training.TrainingInfo()
	baseSwimming.Calories = s.Calories()
	return baseSwimming
}
